...
import 'sample/form-river-manual-image-request.dart';
import 'sample/form-river-sample-data-log.dart';
import 'sample/form-river-sample-triennial.dart';
...
class _UserRiverSample extends State<UserRiverSample> with TickerProviderStateMixin {
  bool isDisplay = true;
    ...
    final List<Map<String, dynamic>> sections = [
      {
        ...
        'items': [
          {'label': 'Sampling Data', 'action': () => _navigateTo(SFormRiverSample())},
        ],
      },
      {
      ...
      },
      {
        ...
        'items': [
          {'label': 'Report Data', 'action': () => _navigateTo(SFormRiverManualTriennial())},
        ],
      },
      {
        ...
        'items': [
          {'label': 'Data Log Report', 'action': () => _navigateTo(SFormRiverManualDataLog())},
        ],
      },
      {
        ...
        'items': [
          {'label': 'Image Request', 'action': () => _navigateTo(SFormRiverManualImageRequest())},
        ],
      },
    ];
                ...
                Wrap(
                  ...
                  children: List.generate(section['items'].length, (i) {
                    ...
                    return ConstrainedBox(
                      ...
                      child: _animatedButton(item['label'], item['action'], indexOffset + i),
                    );
                  }),
                ),
