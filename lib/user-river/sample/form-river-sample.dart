...
class _SFormRiverSample extends State<SFormRiverSample> {
  ...
  void _sendDataServer() async {
    ...
    if (data['statusCode']==201) {
      ...
      if (_image1 != null) { // upload image 1
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=river_sampling&id="+stationID!+"&timestamp="+timestampResult2!+"&description=left_side");
      ...
      if (_image2 != null) { // upload image 2
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=river_sampling&id="+stationID!+"&timestamp="+timestampResult2!+"&description=right_side");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image2!.path,
      ...
      if (_image3 != null) { // upload image 3
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=river_sampling&id="+stationID!+"&timestamp="+timestampResult2!+"&description=bottom_side");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image3!.path,
      ...
      if (_image4 != null) { // upload image 4
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=river_sampling&id="+stationID!+"&timestamp="+timestampResult2!+"&description=front_side");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image4!.path,
      ...
      if (_image5 != null) { // upload image 5
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=river_sampling&id="+stationID!+"&timestamp="+timestampResult2!+"&description=optional1");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image5!.path,
      ...
      if (_image6 != null) { // upload image 6
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=river_sampling&id="+stationID!+"&timestamp="+timestampResult2!+"&description=optional2");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image6!.path,
      ...
      if (_image7 != null) { // upload image 7
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=river_sampling&id="+stationID!+"&timestamp="+timestampResult2!+"&description=optional3");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image7!.path,
      ...
      if (_image8 != null) { // upload image 8
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=river_sampling&id="+stationID!+"&timestamp="+timestampResult2!+"&description=optional4");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image8!.path,
  ...
  void _sendDataLocalStorage() async {
    ...
    bool success = await db.insertDataRiverSample(
      tableName: 'tbl_river_manual_sampling',
      values: {
    ...
    if (success == true) {
      ...
      if (_image1 != null) { // upload image 1
        ...
        String folderName = "manual_sample/"+stationID!;
