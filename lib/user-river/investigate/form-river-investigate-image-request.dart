...
class SFormRiverISImageRequest extends StatefulWidget {
  _SFormRiverISImageRequest createState() => _SFormRiverISImageRequest();
}

class _SFormRiverISImageRequest extends State<SFormRiverISImageRequest> {
  ...
  // ====== API ======
  Uri _buildUri() {
    const base = 'https://mmsv2.pstw.com.my/get-river-is-image-request.php';
