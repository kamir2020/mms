...
class SFormInvestigateSampling extends StatefulWidget {
  _SFormInvestigateSampling createState() => _SFormInvestigateSampling();
}

class _SFormInvestigateSampling extends State<SFormInvestigateSampling> {
  ...
  final List<String> items = ['Schedule','Triennial'];
                    ...
                    child: DropdownSearch<localLocation>(
                      ...
                      onChanged: (localLocation? value) {
                        ...
                        if (value != null) {
                          ...
                          _selectedStationName.text = selectedLocalLocation!.locationName;
  ...
  late String _img5='',_img6='',_img7='',_img8='',_img9='';
  ...
  Future<void> _takePicture9a(ImageSource source) async {
    try {
      final XFile? photo = await _picker9.pickImage(source: source,
        maxWidth: 500,
        maxHeight: 200,
        imageQuality: 80,);
                  ...
                  child: Row(
                    children: [
                      ...
                      Align(
                        ...
                        child: IconButton(
                          onPressed: () {
                            _takePicture9a(ImageSource.gallery);
                          },
                          icon: Icon(
                            size: 30,
                            Icons.collections,
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                flex: 3,
                child: Text(stationID + " & " + _selectedStationName.text),
              ),
            ],
          ),
          SizedBox(height: 5.0,),
  ...
  void _sendDataServer() async {
    ...
    if (data['statusCode']==404) {
        ...
        for (String email in emailList) {
          final message = Message()
            ...
            ..text = '1st Sampler Name : ' + firstSamplerName.toString() +
                ...
                '\nLocation Name : ' + _selectedStationName.text.toString() +', '+ _selectedStateName.toString() +
                '\nDistance : ' + _distanceDevice.toString();
      ...
      if (_image1 != null) { // upload image 1
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=marine_study_sampling&id="+stationID+"&timestamp="+timestampResult2!+"&description=left_side");
      ...
      if (_image2 != null) { // upload image 2
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=marine_study_sampling&id="+stationID+"&timestamp="+timestampResult2!+"&description=right_side");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image2!.path,
      ...
      if (_image3 != null) { // upload image 3
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=marine_study_sampling&id="+stationID+"&timestamp="+timestampResult2!+"&description=filling_water");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image3!.path,
      ...
      if (_image4 != null) { // upload image 4
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=marine_study_sampling&id="+stationID+"&timestamp="+timestampResult2!+"&description=seawater_in_clear_glass");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image4!.path,
      ...
      if (_image5 != null) { // upload image 25
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=marine_study_sampling&id="+stationID+"&timestamp="+timestampResult2!+"&description=examine_preservative");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image5!.path,
      ...
      if (_image6 != null) { // upload image 6
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=marine_study_sampling&id="+stationID+"&timestamp="+timestampResult2!+"&description=optional1");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image6!.path,
      ...
      if (_image7 != null) { // upload image 7
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=marine_study_sampling&id="+stationID+"&timestamp="+timestampResult2!+"&description=optional2");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image7!.path,
      ...
      if (_image8 != null) { // upload image 8
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=marine_study_sampling&id="+stationID+"&timestamp="+timestampResult2!+"&description=optional3");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image8!.path,
      ...
      if (_image9 != null) { // upload image 9
        final uri = Uri.parse("https://mmsv2.pstw.com.my/upload-image.php?action=marine_study_sampling&id="+stationID+"&timestamp="+timestampResult2!+"&description=optional4");
        var request = http.MultipartRequest('POST', uri);
        request.files.add(await http.MultipartFile.fromPath(
          'image',
          _image9!.path,
  ...
  void _sendDataLocalStorage() async {
    ...
    bool success = await db.insertDataMarineStudySampling(
      tableName: 'tbl_marine_study_sampling',
      values: {
    ...
    if (success == true) {
      ...
      if (_image1 != null) { // upload image 1
        ...
        String folderName = "manual_study_sampling/"+stationID;
