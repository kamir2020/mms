...
class SFormAirImageRequest extends StatefulWidget {
  _SFormAirImageRequest createState() => _SFormAirImageRequest();
}

class _SFormAirImageRequest extends State<SFormAirImageRequest> {
  ...
  final List<Item> items = const [
    Item(id: 1, categoryName: 'Installation'),
    Item(id: 2, categoryName: 'Data Collection'),
  ];
  ...
  // ====== API ======
  Uri _buildUri() {
    const base = 'https://mmsv2.pstw.com.my/get-air-image-request.php';
